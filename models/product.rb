...
#irb(main):018:0* columns
#=> ["id: integer", "name: string", "description: string", "price: decimal", "stock_quantity: integer", "category_id: integer", "created_at: datetime", "updated_at: datetime"]
#irb(main):019:0>
